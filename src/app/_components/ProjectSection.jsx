...
const projects = [
    ...
    },
    {
        ...
        description: 'A progressive web App for taking notes oine built using React. T.',
...
const ProjectCard = ({ title, description, link }) => {
    return (
        <Link href={ link } className="block border w-full border-gray5  p-6 shadow-sm bg- rounded-lg  hover:border-gray7 bg-gray1 transition duration-300">
