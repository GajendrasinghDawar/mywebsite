...
export function Intro() {
    return (
        <article className="px-4 md:px-0 my-6 text-gray12">
            <p className="font-medium">
                Hello <HandWaving />, I'm a Web developer with a foundation in both backend and frontend technologies. Live in Khargone(M.P.), India.
            </p>
